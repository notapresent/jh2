...
class Config(object):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+mysqldb://rbm2m:rbm2m@127.0.0.1/rbm2m?charset=utf8'
...
class TestingConfig(Config):
    TESTING = True
    SQLALCHEMY_DATABASE_URI = 'mysql+mysqldb://rbm2m:rbm2m@localhost/rbm2m_test?charset=utf8'
